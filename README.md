...
## Struttura Codice
Il codice, contenuto per la maggior parte nel file Gender_Econ_Pipeline_Git.py, si struttura in quattro sezioni:
1. Enviroment Set Up
2. Previous Analysis Check
3. Data Analysis
4. Graphic Plot <br/>

Inoltre, per semplice questione di ordine, due funzioni sono definite in un file esterno, nominato functions_Git.py.<br/>
Fondamentali per il funzionamento del codice sono i due file generati una volta che questo viene eseguito: graph.png e years.csv.
